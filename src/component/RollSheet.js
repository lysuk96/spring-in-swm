    ...
    return(
        <div>
            <div class="container" >
                ...
                <h6 style ={{fontFamily: 'Yeon Sung, cursive', fontSize:'1.75rem'}}>매일 자정 새로운 쪽지들이 열려요! 매칭된 상대를 찾아보세요!</h6>
            </div>
            <div class="container" style={{marginTop: '50px'}}>
                <img class="mail-box" src={mailBox} style={{width:'150px', height:'150px', marginTop:'0px', marginBottom:'50px', border:'0px'}}/>
                        <div class="row">
                            {
...
function Card(props){
    const styledRandom = (idx, isMatched) => {
        ...
        if (isMatched){
            return {
                boxShadow : '0 0 5px '+borderArray[(idx%4)]+', 0 0 25px '+borderArray[(idx%4)]+', 0 0 50px '+borderArray[(idx%4)]+', 0 0 100px '+borderArray[(idx%4)],
